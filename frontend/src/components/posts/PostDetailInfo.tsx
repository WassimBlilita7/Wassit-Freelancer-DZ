...
import { timeAgo } from "../../utils/formatDate"; // Importer timeAgo
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex items-start space-x-4">
          <FaMoneyBillWave className="text-[var(--success)] text-3xl" />
          <div>
            <p className="text-xl font-semibold text-[var(--text)]">Budget</p>
            <p className="text-2xl text-[var(--success)]">{post.budget.toLocaleString()} DA</p>
          </div>
        </div>
        <div className="flex items-start space-x-4">
          <FaClock className="text-[var(--secondary)] text-3xl" />
          <div>
        ...
        <div className="flex items-start space-x-4 md:col-span-2">
          <FaTags className="text-[var(--accent)] text-3xl" />
          <div>
        ...
        <div className="flex items-start space-x-4">
          <FaFolderOpen className="text-[var(--primary)] text-3xl" />
          <div>
            <p className="text-xl font-semibold text-[var(--text)]">Catégorie</p>
            <p className="text-2xl text-[var(--primary)]">{post.category?.name || "Non spécifiée"}</p>
          </div>
        </div>
        <div className="flex items-start space-x-4">
          <FaClock className="text-[var(--secondary)] text-3xl" />
          <div>
            ...
            <p className="text-2xl text-[var(--secondary)]">{timeAgo(post.createdAt)}</p> {/* Utilisation de timeAgo */}
          </div>
        </div>
      </div>
    </motion.div>
