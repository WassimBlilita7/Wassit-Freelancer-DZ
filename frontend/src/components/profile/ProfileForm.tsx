  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8">
      ...
      <motion.div
        ...
        className="lg:w-1/3"
      >
        <Card className="shadow-xl rounded-xl" style={{ backgroundColor: "var(--profile-sidebar-bg)" }}>
          <CardHeader
              ...
              <div className="flex gap-4">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    ...
                    style={{
                      backgroundColor: "var(--profile-button-save)",
                      color: "#FFFFFF",
                    }}
                    disabled={submitting}
                  >
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    ...
                    className="w-full py-3 flex items-center justify-center"
                    style={{
                      backgroundColor: "var(--profile-button-cancel)",
                      color: "#FFFFFF",
                    }}
                    onClick={resetForm}
                    disabled={submitting}
